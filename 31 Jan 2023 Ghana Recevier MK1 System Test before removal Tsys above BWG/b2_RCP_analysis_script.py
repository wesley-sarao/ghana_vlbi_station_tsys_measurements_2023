...
temp_hot_load_degrees_C = 31 # Read from the EMS 
...
Teff_B2_RCP_FH = np.load("B2RCP//Teff_B2RCP_nom_gain_-5dB_FH_mode_3.npy")
Teff_B2_RCP_BWG = np.load("B2RCP//Teff_B2RCP_nom_gain_-5dB_BWG_mode_3.npy")


plt.figure(6)
plt.clf()
plt.plot(skyfreq/1e6,Teff_B2_RCP_FH, linewidth=1, label='$T_e$ B2_RCP above FH')
plt.plot(skyfreq/1e6,Teff_B2_RCP_BWG, linewidth=1, label='$T_e$ B2_RCP above BWG')

plt.title("Band 2 RCP difference between Tsys taken above BWG and FH")
plt.xlabel("Frequency (MHz)")
plt.ylabel("Noise Temperature (K)")
plt.grid(b='on',which='both',color='black', linestyle='-', linewidth=0.5)
plt.ylim((60,110))
...
plt.plot(skyfreq/1e6,Teff_B2_RCP_BWG-Teff_B2_RCP_FH, linewidth=1, label='$T_e$ B2_RCP above BWG')

plt.title("Band 2 RCP Tsys taken above BWG minus tsys taken above FH")
plt.xlabel("Frequency (MHz)")
plt.ylabel("Noise Temperature (K)")
plt.grid(b='on',which='both',color='black', linestyle='-', linewidth=0.5)
plt.ylim((-10,10))
