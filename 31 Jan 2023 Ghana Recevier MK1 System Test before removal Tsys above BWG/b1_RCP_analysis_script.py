...
Teff_B1_RCP_FH = np.load("B1RCP//Teff_B1RCP_nom_gain_-5dB_FH.npy")
Teff_B1_RCP_BWG = np.load("B1RCP//Teff_B1RCP_nom_gain_-5dB_BWG_mode_1.npy")


plt.figure(6)
plt.clf()
plt.plot(skyfreq/1e6,Teff_B1_RCP_FH, linewidth=1, label='$T_e$ B1_RCP above FH')
plt.plot(skyfreq/1e6,Teff_B1_RCP_BWG, linewidth=1, label='$T_e$ B1_RCP above BWG')

plt.title("Band 1 RCP difference between Tsys taken above BWG and FH")
plt.xlabel("Frequency (MHz)")
plt.ylabel("Noise Temperature (K)")
plt.grid(b='on',which='both',color='black', linestyle='-', linewidth=0.5)
plt.ylim((100,140))
...
plt.plot(skyfreq/1e6,Teff_B1_RCP_BWG-Teff_B1_RCP_FH, linewidth=1, label='$T_e$ B1_RCP above BWG')

plt.title("Band 1 RCP Tsys taken above BWG minus tsys taken above FH")
plt.xlabel("Frequency (MHz)")
plt.ylabel("Noise Temperature (K)")
plt.grid(b='on',which='both',color='black', linestyle='-', linewidth=0.5)
plt.ylim((-10,10))
